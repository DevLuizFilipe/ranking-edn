...
function classificacao(lista) {
    ...
    for (let i = 0; i < quantidadeColunas; i++) {
        ...
        for (let j = 0; j < lista.length; j++) {
            ...
            if (posicao == (i + 1)) {
                switch (posicao) {
                    case 1: imgUrl = "./images/premio1.png"; break;
                    case 2: imgUrl = "./images/premio2.png"; break;
                    case 3: imgUrl = "./images/premio3.png"; break;
                    default: imgUrl = "./images/premio4.png"; break;
                }
...
function filtrar() {
    ...
    if (alunosOrdemAZ.innerText.length > 0) {
        if (filtroAZ) {
            ...
            filtroOrdemAZ.style.backgroundImage = ("url('./images/filtroAZ.png')");
        } else {
            alunosOrdemAZ.innerText = listaOrdenada;
            filtroOrdemAZ.style.backgroundImage = ("url('./images/filtroPorcentagem.png')");
        }
        filtroAZ = !filtroAZ;
    }
}
